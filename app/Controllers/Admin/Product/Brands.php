...
class Brands extends AdminController
{
    ...
    public function index()
    {
        ...
        return view('admin/product/brands/manage_brands_list', $data);
    }
    ...
    public function datatable_json()
    {
        ...
        foreach ($details as $k => $v) {
            ...
            $action = '';
            if (check_method_access('brands', 'edit', true)) {
                $action .= '<a title="Edit" style="font-size: 1.2rem;" class="text-warning sup_update me-1" href="' . base_url("/admin/product/brands/edit/" . $v->id) . '" brand_id="' . $v->id . '" > <i class="fa fa-pencil-square-o"></i></a>';
            }
            if (check_method_access('brands', 'delete', true)) {
                $action .= '<a title="Delete" style="font-size: 1.2rem;" class="text-danger brand_delete me-1"  brand_id="' . $v->id . '" href="#" title="Delete" data-bs-toggle="modal" data-bs-target="#modal-center" > <i class="fa fa-trash-o"></i></a>';
            }
            $arr[] = [
                $product_img,
                $v->name,
    ...
    public function add()
    {
        ...
        if ($this->request->getPost('name')) {
            ...
            return view('admin/product/brands/add_brands', $data);
        }
    }
    public function edit($id)
    {
        ...
        if ($this->request->getPost('name')) {
            ...
            return view('admin/product/brands/edit_brands', $data);
        }
    }
