<div class="modal center-modal fade" id="mdl_add_user">
    <div class="modal-dialog  modal-lg modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="mb-0 text-info"><i class="fa fa-plus"></i> <?php echo trans('create_user') ?></h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="m-3">
                <form method="post" autocomplete="off" id="frm-add-user" onsubmit="return false">
                    <?php echo csrf_field() ?>
                            ...
                            <div class="box-body m-0 p-0">
                                <div class="form-group">
                                    <div class=" d-flex flex-column align-items-center justify-content-center">
                                        <div class='d-flex bg-secondary  align-items-center justify-content-center mb-2' style='height: 225px; width:250px;'>
                                            <img src="<?php echo base_url('public/images/avatar/avatar-1.png') ?>" id="logo" class="logo" style='max-height:100%; max-width:100%;'>
                                        </div>

                                        <a type="text" class="btn btn-info btn-sm" id="user-cho-img"><?php echo trans('btn_choose_img') ?></a>
                                        <input type="file" class='d-none' name="logo" id="user-profile" accept=".png, .jpg, .jpeg, .gif, .svg">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label for="inputgst"><?php echo trans("gstin") ?></label>
                            <div class="controls">
