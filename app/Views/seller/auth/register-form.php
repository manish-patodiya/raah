<div class="row h-p100 shadow bg-white">
    <div>
        <div class="px-20 pt-40 pb-0 d-flex flex-column align-items-center position-relative">
            ...
            <h4 class='text-theme mt-2' style='color:#7d7777'>Create your account to start selling</h4>
        </div>
        <div class="px-15 py-20">
            <form id='frm-register' method="post">
                ...
                <div class='text-center'>
                    <small class='text-light'>By clicking you agree to our <a href='#' class='text-theme'>Terms
                            & Conditions</a> and <a href='#' class='text-theme'>Privacy Policy</a></small>
                </div>
            </form>
        </div>
    </div>
