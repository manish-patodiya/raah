    ...
    <div class="container-full">
        <section class="content">
            ...
            <?php if (!$user_detail->is_email_verify) : ?>
                <div class="alert alert-danger" id='error-msg'>Note: Hi <?php echo $user_detail->full_name ?>, Your email is not
                    verified yet.
                    please <a href='<?php echo base_url('seller/profile') ?>' onclick='//sendVerificationEmail()'>verify</a> or
                    <a href='<?php echo base_url('seller/profile') ?>' onclick="//$('#div-get-email').slideDown('slow')">change</a>
                    your email
            ...
            <div class="row">
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-header bg-img bbsr-0 bber-0" style="background: base_url('public/images/gallery/full/10.jpg') center center;" data-overlay="5">
                        ...
                        <div class="widget-user-image">
                            <img class="rounded-circle h-90" id='user-profile' src="<?php echo $info->profile_photo ?: base_url('public/images/avatar/avatar-1.png') ?>" alt="User Avatar">
                        ...
                        <div class="box-body box-profile">
                            <div class="form-group row">
                                ...
                                <div class="controls col-md-7">
                                    <p id='email-hide'>: <span class="text-gray ps-10"><?php echo $info->email ?></span></p>
                                    <form id='frm-change-email'>
                                        <?php echo csrf_field() ?>
                                        <input type="hidden" name='user_id' value='<?php echo encrypt_var($user_detail->uid) ?>'>
                                        <div class='input-group d-none' id='div-get-email'>
                                            <input type="text" class='form-control col-md-8' name='email' value="<?php echo $info->email ?>" placeholder='Enter your email id' />
                                        </div>

                                </div>
                                <div class="col-md-3">
                                    <a href='#' id='verify' onclick="$('#div-get-email').removeClass('d-none'),$('#email-hide').hide(),$('#change').removeClass('d-none'), $('#change').addClass('d-block'),$(this).hide();">Change</a>

                                    <button type="submit" class='btn btn-primary btn-sm d-none' id='change' onclick="$('#div-get-email').addClass('d-none'),$('#email-hide').show(),$('#verify').show(),$(this).addClass('d-none');">Verify</button>
                            ...
                            <div class='row'>
                                ...
                                <div class="form-group row">
                                    <label for="inputPhone" class="col-md-2 form-label"><?php echo trans('address') ?></label>

                                    <div class="col-md-9">
                                        <p>: <span class="text-gray ps-10"><?php echo $user_detail->address . ', ' . $user_detail->state_name . ', ' . $user_detail->city_name ?></span>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="profile">
                                ...
                                <form class="form-horizontal col-12" id="user_profile_updete_detail" onsubmit="return false">
                                    <?php echo csrf_field(); ?>
                                    <input type="file" class='d-none' name="logo" id="user-img" accept=".png, .jpg, .jpeg, .gif, .svg">
                                    <div class="box no-shadow">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="controls col-md-7">
                                                <input type="email" class="form-control" name="update_email" id="inputEmail" placeholder="Enter your email" value="<?php echo $info->email ?>">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="controls  col-md-7">
                                                <input type="number" class="form-control" name="update_phone" id="inputPhone" placeholder="Enter your phone NO." value="<?php echo $info->phone ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPhone" class="col-md-2 form-label"><?php echo trans('address') ?></label>
                                            ...
                                            <div class="controls  col-md-7">
                                                <input type="text" class="form-control" name="update_address" id="inputPhone" placeholder="Enter your address" value="<?php echo $info->address ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPhone" class="col-md-2 form-label"><?php echo trans('state') ?></label>

                                            <div class="controls  col-md-7">
                                                <select name="state" class="form-control" id='state'>
                                                    <option value=""><?php echo trans('select_state') ?></option>
                                                    <?php foreach ($states as $state) : ?>
                                                        <option value="<?php echo $state->state_id ?>" <?php echo $state->state_id == $info->state_id ? 'selected' : false ?>>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputPhone" class="col-md-2 form-label"><?php echo trans('city') ?></label>

                                            <div class="controls  col-md-7">
                                                <select name="city" class="form-control" id='citie'>
                                                    <option value=""><?php echo trans('select_city') ?></option>
                                                    <?php foreach ($city as $city) : ?>
                                                        <option value="<?php echo $city->city_id ?>" <?php echo $city->city_id == $info->city_id ? 'selected' : false ?>>
...
<?php
echo view('seller/include/footer');
?>
