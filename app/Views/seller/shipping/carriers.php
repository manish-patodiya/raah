                                ...
                                <div class="card card-default">
                                    <div class="m-3">
                                        <form method="post" autocomplete="off" id="frm-order-setting-detail" onsubmit="return false">
                                            <?php echo csrf_field(); ?>
                                            <h4 class="mb-0"><i class="fa fa-plus"></i> <?php echo trans('create_carriers') ?></h4>
                                            <hr class="my-15">
                                            <div class="form-group">
                                                <label for="username" class="control-label"><?php echo trans('carriers') ?></label>
                                                <div class="controls">
                                                    <textarea type="text" name="carriers" class="form-control" id="carriers" placeholder="Enter your Cancel Reason" rows="3"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
