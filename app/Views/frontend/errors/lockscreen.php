...
<body class="theme-success bg-img" style="background-image: url(../images/front-end-img/background/bg-5.jpg)">
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="box box-body mb-0">
							...
							<div class="p-40">
									...
									<div class="form-group">
									  ...
									  <div class="row">
										<div class="col-12 text-center">
										  <button type="submit" class="btn btn-info w-p100">Unlock</button>
										</div>
										<!-- /.col -->
									  </div>
								</form>	
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Or <a href="login.html" class="text-warning"><b>Log In</b></a> as a Different User</p>
								</div>
							</div>
						</div>
					</div>
