                    ...
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="bg-white rounded10 shadow-lg">
                            <div class="content-top-agile p-20 pb-0">
                                <h2 class="text-primary"><?php echo trans('set_password') ?></h2>
                            </div>
                            <div class="p-40">
                                <div class="alert alert-danger" id="change-pass-err" style="display: none;"></div>
                                <form method="post" autocomplete="off" id="reset-password" onsubmit="return false">
                                    <?php echo csrf_field() ?>
                                    ...
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-success mt-10" id="btn-change-pass"><?php echo trans('save') ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
