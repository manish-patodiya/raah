<div class="modal center-modal  fade" id="mdl_view_user">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-start">
                <h5> <span class="subject" style="word-wrap: break-word;"><?php echo trans('seller_profile_view') ?></span></h5>
            ...
            <div class="modal-body" style='min-height:200px'>
                <div class='row'>
                    ...
                    <div class="col-md-7 border">
                        ...
                        <div class="row">
                            <label for="" class='col-md-3'><?php echo trans('gstin') ?></label>
                            <span class="text-gray ps-10 col-md-9" id='span-gst'></span>
                        </div>
                        <div class="row">
