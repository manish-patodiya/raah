                        ...
                        <div class="card card-default">
                            <div class="m-3">
                                <form method="post" autocomplete="off" id="frm-order-setting-detail"
                                    ...
                                    <?php echo csrf_field(); ?>
                                    <h4 class="mb-0"><i class="fa fa-plus"></i>
                                        <?php echo trans('create_pickup_locations') ?>
                                    </h4>
                                    <hr class="my-15">
                                    <div class="form-group">
                                        <label for="username"
                                            class="control-label"><?php echo trans('pickup_locations') ?> <span
                                                class="required"> *</span></label>
                                        <div class="controls">
                                            <textarea type="text" name="pickuplocations" class="form-control"
                                                id="pickuplocations" placeholder="Enter your pickup locations"
                                                rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
