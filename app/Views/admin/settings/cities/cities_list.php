                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class=" form-group">
                                                        <label class="control-label"><?php echo trans('city_name') ?> <span class="required"> *</span></label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="username" class="control-label"><?php echo trans('state') ?> <span class="required"> *</span></label>
                                                        <div class="controls">
