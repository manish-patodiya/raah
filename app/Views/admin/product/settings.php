                            ...
                            <div class='row mb-3'>
                                <div class='col-md-3'>
                                    <div class='form-group controls'>
                                        <label for=""><?php echo trans('per_page_web') ?> <span class="required">
                                                *</span></label>
                                ...
                                <div class='col-md-3'>
                                    <div class='form-group controls'>
                                        <label for=""><?php echo trans('per_page_mobile') ?> <span class="required">
                                                *</span></label>
                                ...
                                <div class='col-md-3'>
                                    <div class='form-group controls'>
                                        <label for=""><?php echo trans('max_product_limit') ?> <span class="required">
                                                *</span></label>
