            ...
            <div class="row">
                ...
                <?php if (check_method_access('categories', 'add', true)) : ?>
                    <div class="col-md-4" id='div-add-cat'>
                        <div class="card card-default">
                            <div class="m-3">
                                <form method="post" enctype="multipart/form-data" autocomplete="off" id="categories_detail" onsubmit="return false">
                                    <?php echo  csrf_field(); ?>
                                    <h4 class="mb-0"><i class="fa fa-plus"></i> Add New Category</h4>
                                    <hr class="my-15">
                                    <div class='form-group'>
                                        <label for="">Category Image (Select to change)</label>
                                        <input type="file" name="cat_image" id="slct-image" class='form-control' />
                                    </div>
                                    <div class='form-group'>
                    ...
                    <div class="col-md-4 d-none" id='div-edit-cat'>
                        <div class="card p-3">
                            ...
                            <form method="post" id="edit_form" autocomplete="off" onsubmit="return false">
                                ...
                                <div class='form-group'>
                                    <img src="" id="cat_image" style="width:100%;" class=" p-40" />
...
if (check_method_access('categories', 'add', true)) {
    echo view('admin/modals/product/upload_csv_file.php');
}
echo view('admin/include/footer.php');
?>

<script src="<?php echo  base_url('public/custom/js/category.js') ?>"></script>