            ...
            <div class="app-menu">
                <ul class="header-megamenu nav">
                    ...
                    <li class="btn-group d-lg-inline-flex d-none align-items-center">
                        <span class='badge badge-success badge-lg px-4'>Admin</span>
                    </li>
                </ul>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#"
                            ...
                            <img src="<?php
echo $session->admin_info['profile_photo']; ?>" class="avatar rounded-10 bg-primary-light h-40 w-40" alt="" />
                        </a>
                        <ul class="dropdown-menu animated flipInX">
                            <li class="user-body">
                                ...
                                <a class="dropdown-item" href="<?php echo base_url('admin/auth/logout') ?>"><i
