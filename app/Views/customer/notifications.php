                                        ...
                                        <tbody>
                                            <?php foreach ($notifications as $n) : ?>
                                                <tr onclick="redirect('<?php echo $n->uri ?>',event)">
                                                    ...
                                                    <td><button type="button" class="btn btn-primary btn-sm" noti_id='<?php echo $n->id ?>' onclick="delete_notification_by_customer(this,event)"><i class="ion ion-trash-a"></i></button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
